module.exports = (app) => {
    ...
    app.post("/contas/pagar/adicionar", app.controllers.contasController.adicionar_pagar)
    app.post("/contas/receber/adicionar", app.controllers.contasController.adicionar_receber)
